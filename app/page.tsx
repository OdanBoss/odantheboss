  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-4 gap-5">
        <StatCard title="Reproducciones Totales" value={formatNumber(totalStreams)} change={18.4} icon={PlayCircle} accent="#7c3aed" sub="Últimos 11 meses" />
        <StatCard title="Ingresos Totales" value={formatCurrency(totalRevenue)} change={22.1} icon={DollarSign} accent="#10b981" sub="Acumulado 2024–2025" />
        <StatCard title="Oyentes Únicos" value={formatNumber(3450000)} change={15.2} icon={Users} accent="#f59e0b" sub="Este mes" />
        <StatCard title="Canciones Activas" value="7" change={16.7} icon={Music2} accent="#ec4899" sub="En todas las plataformas" />
      </div>
